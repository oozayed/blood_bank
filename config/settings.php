...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Database table used to store general in.
    |
    */
    'table' => 'settings',
    ...
    |--------------------------------------------------------------------------
    |
    | If enabled, all general are cached after accessing them.
    |
    */
    'cache' => true,
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The driver to use to store and retrieve general from. You are free
    ...
    */
    ...
    | add the `team_foreign_key` column to the general table, and update the
