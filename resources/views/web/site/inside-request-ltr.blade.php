        ...
        <div class="upper-bar">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <div class="language">
                            <a href="inside-request-ltr.html" class="en active">EN</a>
                            <a href="inside-request.blade.php" class="ar inactive">عربى</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="social">
                ...
                <div class="path">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="donation-requests-ltr.blade.php">Donation requsets</a></li>
