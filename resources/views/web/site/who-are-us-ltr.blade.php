        ...
        <div class="upper-bar">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <div class="language">
                            <a href="who-are-us-ltr.html" class="en active">EN</a>
                            <a href="who-are-us.blade.php" class="ar inactive">عربى</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="social">
                    ...
                    <div class="row">
                        ...
                        <div class="pages col-md-4">
                            <div class="list-group" id="list-tab" role="tablist">
                                ...
                                <a class="list-group-item list-group-item-action active" id="list-settings-list" href="who-are-us-ltr.html" role="tab" aria-controls="settings">Who are us</a>
