        ...
        <div class="upper-bar">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <div class="language">
                            <a href="who-are-us.html" class="ar active">عربى</a>
                            <a href="who-are-us-ltr.blade.php" class="en inactive">EN</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="social">
                    ...
                    <div class="row">
                        ...
                        <div class="pages col-md-4">
                            <div class="list-group" id="list-tab" role="tablist">
                                ...
                                <a class="list-group-item list-group-item-action active" id="list-settings-list" href="who-are-us.html" role="tab" aria-controls="settings">من نحن</a>
