        ...
        <div class="upper-bar">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <div class="language">
                            <a href="inside-request.html" class="ar active">عربى</a>
                            <a href="inside-request-ltr.blade.php" class="en inactive">EN</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="social">
                ...
                <div class="path">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="donation-requests.blade.php">طلبات التبرع</a></li>
